...
<head>
    ...
    <title>Reestablece tu contraseña - UpTask</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 48px 40px;">
                            ...
                            <p style="margin: 0 0 24px; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                Hemos recibido una solicitud para <strong style="color: #6366f1;">restablecer tu contraseña</strong> en UpTask. Si no fuiste tú, puedes ignorar este correo de forma segura.
                            </p>
                            
                            <!-- Warning Box -->
                            <div style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-left: 4px solid #f59e0b; border-radius: 12px; padding: 20px; margin: 0 0 32px;">
                                <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 1.6;">
                                    <strong>⚡ Acción requerida:</strong> Este enlace expirará en 10 minutos por tu seguridad. Asegúrate de completar el proceso pronto.
                                </p>
                            </div>
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                <tr>
                                    <td align="center" style="padding: 0 0 32px;">
                                        <a href="${resetUrl}" style="display: inline-block; padding: 16px 48px; background: linear-gradient(135deg, #6366f1 0%, #a855f7 100%); color: #ffffff; text-decoration: none; border-radius: 12px; font-weight: 700; font-size: 16px; box-shadow: 0 4px 12px rgba(99, 102, 241, 0.4); transition: all 0.3s ease;">
                            ...
                            <div style="border-top: 1px solid #e5e7eb; margin: 32px 0; padding-top: 32px;">
                                ...
                                <p style="margin: 0; padding: 12px; background-color: #f9fafb; border-radius: 8px; word-break: break-all;">
                                    <a href="${resetUrl}" style="color: #6366f1; text-decoration: none; font-size: 13px;">
                                        ${resetUrl}
                                    </a>
                                </p>
                            </div>
                            ...
                            <div style="background-color: #1f2937; border-radius: 12px; padding: 20px; margin: 32px 0 0;">
                                ...
                                <ul style="margin: 8px 0 0; padding-left: 20px; color: #d1d5db; font-size: 13px; line-height: 1.8;">
